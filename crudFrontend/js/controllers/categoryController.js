...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    const modal  = new bootstrap.modal(document.getElementById("categiryModal"));
    const lblModal = document.getElementById("categoryModalLabel");
    const btnAdd = document.getElementById("btnAddCategory")
    
    Init();

    btnAdd.addEventListener("clcik", ()=>{
        form.reset();
    ...
    form.addEventListener("submit", async(e)=>{
        e.preventDefault();
        const id = form.catagoryId.value;
        const data = {
    ...
    async function loadCategories(){
        ...
        categories.forEach((cat)=>{
          const tr = document.createElement("tr");
            ...
            console.error("Error cargando categories", err);
        }
